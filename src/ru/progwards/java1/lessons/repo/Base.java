package ru.progwards.java1.lessons.repo;
    ...
    public class Base {
        private static String X_EQUALS= "x = ";
        private static String Y_EQUALS= "y = ";
        private static String A_EQUALS= "a = ";
        private static String B_EQUALS= "b = ";
        private static String C_EQUALS= "c = ";
